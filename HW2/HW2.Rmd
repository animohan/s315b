...
2. Q2
  If number of predictors are greater than the number of observations in the training sample, then to some extent we have an ill-posed problem. Here are some of the challenges:
    + Many of the predictors might not have any contribution in the sample points.
    + Not enough points to get a joint distribution of variables.
    
  + Regularization helps this by constraining the number of variables chosen or the coefficients of variables chosen for building the functions.
